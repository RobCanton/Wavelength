...
protocol ColorPickerDelegate: class {
    func colourSelected(_ color: UIColor)
}
...
open class SwiftHSVColorPicker: UIView, ColorWheelDelegate, BrightnessViewDelegate {
    ...
    func setup() {
        ...
        let colorWheelSize = min(self.bounds.width, self.bounds.height - 0.0 - brightnessViewHeight)
        ...
        colorWheel.applyShadow(radius: 6.0, opacity: 0.20, height: 0.0, shouldRasterize: false)
        brightnessView.applyShadow(radius: 6.0, opacity: 0.20, height: 0.0, shouldRasterize: false)
    }
    ...
    func hueAndSaturationSelected(_ hue: CGFloat, saturation: CGFloat) {
        ...
        delegate?.colourSelected(self.color)
    }
